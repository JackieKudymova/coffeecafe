...
function PaginationButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={`
        inline-flex size-10 md:h-[35px] lg:h-10 shrink-0 items-center justify-center p-0 text-center text-lg md:text-base lg:text-lg font-medium transition-colors rounded-[5px]
