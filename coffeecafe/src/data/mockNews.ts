/*
  Моковые новости - шесть заглушек для вёрстки и демо.
...
export const mockNews: NewsArticle[] = [
  ...
  makeArticle(
    ...
    'В субботу в 14:00 бариста покажет, как рисовать сердечки и розетты на молочной пенке. Запись по телефону.',
    '2026-02-22',
  ),
  makeArticle(
    5,
    ...
    'Завтраки по будням',
    'С понедельника по пятницу к любому кофе - овсяная каша или сырники в подарок при заказе до 10:00.',
    '2026-02-20',
  ),
]
