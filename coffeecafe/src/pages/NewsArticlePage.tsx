...
function NewsArticleBody({ id }: { id: string }) {
  ...
  return (
    <article className="lg:grid lg:grid-cols-12 lg:gap-x-8">
      ...
      <div className="mt-[24px] lg:mt-8 lg:col-span-8 flex flex-col">
