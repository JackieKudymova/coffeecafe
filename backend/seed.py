...
MENU_SEED = [
    (
        ...
        0,
        [
            ("Эспрессо", "menu-coffee.png", "coffee-espresso.png", 1, [("30 мл", 120)]),
            ("Американо", "menu-coffee.png", "coffee-americano.png", 2, [("200 мл", 150), ("300 мл", 170), ("400 мл", 190)]),
            ("Капучино", "menu-coffee.png", "coffee-cappuccino.png", 3, [("200 мл", 170), ("300 мл", 190), ("400 мл", 210)]),
            ("Латте", "menu-coffee.png", "coffee-latte.png", 4, [("250 мл", 180), ("350 мл", 200), ("450 мл", 220)]),
            ("Флэт Уайт", "menu-coffee.png", "coffee-flat-white.png", 5, [("200 мл", 190), ("300 мл", 210), ("400 мл", 230)]),
            ("Раф", "menu-coffee.png", "coffee-raf.png", 6, [("250 мл", 210), ("350 мл", 230), ("450 мл", 250)]),
        ],
    ),
    (
        "Чай",
        1,
        [
            ("Черный чай", "menu-tea.png", "tea-black.png", 1, [("300 мл", 150), ("400 мл", 170), ("500 мл", 190)]),
            ("Зеленый чай", "menu-tea.png", "tea-green.png", 2, [("300 мл", 150), ("400 мл", 170), ("500 мл", 190)]),
            ("Травяной чай", "menu-tea.png", "tea-herbal.png", 3, [("300 мл", 160), ("400 мл", 180), ("500 мл", 200)]),
            ("Фруктовый чай", "menu-tea.png", "tea-fruit.png", 4, [("300 мл", 170), ("400 мл", 190), ("500 мл", 210)]),
        ],
    ),
    (
        "Десерты",
        2,
        [
            ("Чизкейк", "menu-desserts.png", "dessert-cheesecake.png", 1, [("150 г", 240)]),
            ("Брауни", "menu-desserts.png", "dessert-brownie.png", 2, [("100 г", 200)]),
            ("Тирамису", "menu-desserts.png", "dessert-tiramisu.png", 3, [("150 г", 250)]),
            ("Шоколадный трюфель", "menu-desserts.png", "dessert-truffle.png", 4, [("80 г", 210)]),
        ],
    ),
    (
        "Выпечка",
        3,
        [
            ("Круассан", "menu-bakery.png", "bakery-croissant.png", 1, [("80 г", 170)]),
            ("Слойка с шоколадом", "menu-bakery.png", "bakery-chocolate.png", 2, [("90 г", 180)]),
            ("Маффин", "menu-bakery.png", "bakery-muffin.png", 3, [("100 г", 190)]),
            ("Булочка с корицей", "menu-bakery.png", "bakery-cinnamon.png", 4, [("100 г", 180)]),
        ],
    ),
]
